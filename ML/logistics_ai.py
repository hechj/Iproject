...
def gradAscent(dataMatIn, classLabels):
    ...
    for k in range(maxCycles):
        ...
        error = labelMat - h
        t = alpha * dataMatrix.transpose() * error
        weights = weights + t
    print("error={}".format(error))
    print("t={}".format(t))
    print("after sigmoid\nweights={}".format(weights))
    print("weights.getA={}".format(weights.getA()))
