...
s_url = 'https://zhujia.zhuwang.cc/api/chartData?areaId=-1'

# aa= 是时间戳(ms)
# url = 'https://zhujia.zhuwang.cc/api/chartData?areaId=-1&aa=1624518801003'
...
print(data["time"])
print(data['pigprice'])
data["time"] = pd.to_datetime(data["time"].apply(str)).dt.date
